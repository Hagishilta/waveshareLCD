...
void LCD_2IN4_test(void)
{
    ...
    Paint_DrawString_CN(5,240, "¿", &Font24CN, IMAGE_BACKGROUND, BLUE);
    Paint_DrawString_EN(5,260, "hihi", &Font12, IMAGE_BACKGROUND, BLUE); 
    Paint_DrawString_EN(5,280, "¿¿", &Font12, IMAGE_BACKGROUND, BLUE);
